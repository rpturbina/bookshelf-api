...
const getAllBooksHandler = (request, h) => {
  ...
  // * menampilkan seluruh buku yang mengandung nama berdasarkan nilai query parameter
  if (name !== undefined) {
  ...
  // * menampilkan seluruh buku yang sedang dibaca atau sedang tidak dibaca
  ...
  // * menampilkan seluruh buku yang belum atau sudah selesai dibaca
